...
<?php 
    ...
    include(get_template_directory().'/nexus_api/data/nexus_options.php'); 
?>

<?php include(get_template_directory().'/nexus_api/menus/sidebar_menu.php'); ?>
<?php echo nexus_wcAJAX(); ?>
    ...
    jQuery(document).ready(function ($) {
        ...
        // Onlick event to run ALL future pageload queries
            ...
            function nexus_ajaxFunction(dataArr) {
                ...
                if (menu) {
                    $(document).find("#ajaxNavigationContainer").slideUp('fast').load('<?php echo get_bloginfo('url'); ?>/nexus-menu-query/', queryData, function() { 
                ...
                }).load('<?php echo get_bloginfo('url'); ?>/nexus-ajax-query/', queryData, function() {   
