...
<div class="pure-g" id="submitConfirmation" style="display:none;">
    <div class="pure-u-5-5">
        <h1 class="txtC">Thank you for registering as a client!</h1>
        <p class="txtC">
            <?php if (!$nexus_ACTIVATION) { ?>
            Simply change your password <a href="<?php echo wp_lostpassword_url( $nexus_DASHBOARDURL ); ?>">here</a> or via the "Forgot your password?" link in the menu, and you will be able to log in and add requests straight away.
            <?php } else { ?>
                A full member of the site will have to approve your registration before you begin. You will be notified via email once approved, then simply change your password via the "Forgot your password?" link in the menu, and you will be able to log in and add requests.
            <?php } ?>
        </p>
    </div>
</div>

<form id="nexusSignupForm" name="nexusSignupForm" class="nexus_formDataFiles form-style-7" data-function="nexus_userSignup" enctype="form/multipart">
    <input type="hidden" name="signupType" value="client" />
    <div class="pure-g">
        ...
        <div class="pure-u-5-5 pure-u-md-1-2">
            <div style="box-sizing:border-box; padding:20px; max-width:400px; text-align:center; margin: 50px 0;">
